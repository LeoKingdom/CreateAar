...
import fastble.data.BleMsg;
import fastble.data.BleWriteState;
import fastble.exception.GattException;
import fastble.exception.OtherException;
import fastble.exception.TimeoutException;
...
public class BleConnector {
    ...
    private boolean setCharacteristicNotification(BluetoothGatt gatt,
        ...
        List<BluetoothGattDescriptor> descriptorList = null;
