...
/**
 * This fragment allows to build a dialog to display information during the VM upgrade.
 */
...
public class VMUpgradeDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        @SuppressLint("InflateParams") View view = getActivity().getLayoutInflater().inflate(R.layout.dialog_upgrade_progress, null);
    ...
    public void displayTransferProgress(UploadProgress progress) {
        if (this.isAdded() || this.isVisible()) {
            ...
            mTVTime.setText(Utils.getStringForTime(progress.getTime()));
        }
    }
