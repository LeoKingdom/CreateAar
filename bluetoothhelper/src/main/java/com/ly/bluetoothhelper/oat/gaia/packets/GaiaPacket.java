...
package com.ly.bluetoothhelper.oat.gaia.packets;
...
public abstract class GaiaPacket {
     ...
     * {@link com.ly.bluetoothhelper.oat.gaia.GAIA.NotificationEvents NotificationEvents}. The next bytes represent the
