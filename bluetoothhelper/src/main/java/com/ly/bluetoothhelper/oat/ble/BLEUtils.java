...
package com.ly.bluetoothhelper.oat.ble;
...
public class BLEUtils {
     ...
     * These status can be:
     * <ul>
     *     <li>{@link com.ly.bluetoothhelper.oat.ble.ErrorStatus.HCI HCI} or
     *     {@link com.ly.bluetoothhelper.oat.ble.ErrorStatus.ATT ATT} layers related.</li>
     *     <li>Android {@link com.ly.bluetoothhelper.oat.ble.ErrorStatus.GattApi GattApi} implementation related as
     ...
     * <ul>
     *     <li>{@link com.ly.bluetoothhelper.oat.ble.ErrorStatus.HCI#getLabel(int, boolean) HCI.getLabel()} and
     *     {@link com.ly.bluetoothhelper.oat.ble.ErrorStatus.ATT#getLabel(int, boolean) ATT.getLabel()}</li>
     *     <li>{@link com.ly.bluetoothhelper.oat.ble.ErrorStatus.GattApi#getLabel(int, boolean) GattApi.getLabel()}</li>
     *     <li>{@link com.ly.bluetoothhelper.oat.ble.ErrorStatus#getBluetoothGattStatusLabel(int, boolean)
